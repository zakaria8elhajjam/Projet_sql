...
<body>
    ...
    <?php
    if (!empty($_POST['niveau']) && !empty($_POST['matiere'])) {
        ...
        if (mysqli_num_rows($result) == 0) {
            ...
            echo "<div class='tableRow header tableHeader' style='width: 1515px;'>";
            ...
            while ($list = mysqli_fetch_assoc($result)) {
                ...
                echo "<form action='etudiantGroupe.php' method='POST'>";
                    ...
                    echo "<input type='submit' style='margin-left: 10px;margin-right: 35px;' name='show' value='étudiants' class='show'>";
                echo "</form>";
                echo "</div>";
                echo "</div>";
            }
